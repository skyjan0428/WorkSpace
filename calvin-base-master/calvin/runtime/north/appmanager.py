...
# def get_actor_name_map(actors, ns):
...
# def update_node_info(node_info, node_id, actor_id):
#     """ Collect information on current actor deployment """
#     if node_id in node_info:
#         node_info[node_id].append(actor_id)
#     else:
#         node_info[node_id] = [actor_id]
...
# def get_req(deploy_info, actor_name):
#     """
...
# def add(application_id, applications):
#     """ Add an actor """
...
# def finalize(applications, storage, application_id, migrate, cb):
...
def _actor_connectivity(list_actors):
