...
class Server:
    ...
    def listen(self, port, interface='0.0.0.0'):
        ...
        self.transport, self.protocol = listen
    ...
    def bootstrap_node(self, addr):
        result =  self.protocol.ping(addr, self.node.id)
    ...
    def set(self, key, value):
        ...
        dkey = digest(key)
        return self.set_digest(dkey, value)

    def set_digest(self, dkey, value):
        """
        ...
        return any( asyncio.gather(*results))
