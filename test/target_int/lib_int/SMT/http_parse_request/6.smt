...
(assert (not (and (>= (str.to.int version.split("/")[1].split(".")[0]) 1) (>= (str.to.int version.split("/")[1].split(".")[0]) 1))))
(assert (not (and (>= (str.to.int version.split("/")[1].split(".")[0]) 1) (>= (str.to.int version.split("/")[1].split(".")[0]) 1))))
(assert (not (and (>= (str.to.int version.split("/")[1].split(".")[0]) 2) (>= (str.to.int version.split("/")[1].split(".")[0]) 0))))
