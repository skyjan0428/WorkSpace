...
(assert (not (or (<= (str.to.int (str.substr dtstr 5 7)) 0) (> (str.to.int (str.substr dtstr 5 7)) 12))))
(assert (not (not (= (str.at dtstr 7) "-"))))
(assert (not (or (<= (str.to.int (str.substr dtstr 8 10)) 0) (> (str.to.int (str.substr dtstr 8 10)) 32))))
