...
(assert (>= (str.len *@sp422) 3)  )
(assert (= (- (str.to_int (str.substr *@sp422 0 (- (str.len *@sp422) 2))) 6) 6)  )
(assert (not (< (- (str.to_int (str.substr *@sp422 0 (- (str.len *@sp422) 2))) 6) 6)  ) )
(assert (> (- (str.to_int (str.substr *@sp422 0 (- (str.len *@sp422) 2))) 6) 7)  )
(assert (not (>= (- (str.to_int (str.substr *@sp422 0 (- (str.len *@sp422) 2))) 6) 8)  ) )
(check-sat)
 (get-model)
